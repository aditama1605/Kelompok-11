...
export default function RegisterTerapis() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await register(nama, email, password, "terapis");
      if (result.success) {
        showToast("success", "Success", "Registrasi terapis berhasil! Anda akan diarahkan ke halaman login...");
        setNama("");
        setEmail("");
        setPassword("");
        setTimeout(() => {
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mx-auto max-w-2xl text-center mb-12">
            ...
            <p className="mt-4 text-base sm:text-lg leading-8 text-gray-600">
              Daftar sebagai terapis untuk bergabung dengan tim profesional kami.
            </p>
          </div>
