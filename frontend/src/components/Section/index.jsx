...
const Section = () => {
  return (
    <section id="beranda" className="relative flex flex-col lg:flex-row items-center justify-center mx-auto px-4 sm:px-6 py-7 sm:py-14 lg:py-16 max-w-7xl gap-8 lg:gap-12 bg-white">
      {/* Text Content */}
