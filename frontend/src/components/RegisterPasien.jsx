...
export default function RegisterPasien() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!nama || !email || !password) {
      showToast("warning", "Peringatan", "Nama, email, dan password harus diisi");
      return;
    }

    if (!email.toLowerCase().endsWith("@gmail.com")) {
      showToast("warning", "Peringatan", "Email harus menggunakan domain @gmail.com");
      return;
    }
    ...
    try {
      ...
      if (result.success) {
        showToast("success", "Berhasil", "Registrasi berhasil! Mengarahkan ke halaman login...");
        setNama("");
        setEmail("");
        setPassword("");
        setTimeout(() => {
        ...
        showToast("danger", "Gagal", result.message || "Registrasi gagal. Email mungkin sudah digunakan");
      }
    } catch (err) {
      console.error("Registration error:", err);
      showToast("danger", "Error", "Terjadi kesalahan saat registrasi");
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div className="h-full flex flex-col items-center justify-center p-12">
          <div className="text-center text-white max-w-md">
            ...
            <p className="opacity-90 mb-6">
              Daftar sekarang untuk mengakses semua layanan profesional kami
            </p>
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center justify-center">
                ...
                <span>Jadwalkan sesi fisioterapi dengan mudah</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="mt-4 text-3xl font-light text-gray-900">Daftar Akun Pasien</h1>
            <p className="mt-2 text-gray-500">Buat akun untuk mengakses layanan fisioterapi</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Harus menggunakan domain @gmail.com
                </p>
              </div>
...
// Reuse the same Toast component from LoginForm.js
