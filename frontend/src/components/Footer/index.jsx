...
const Section = () => {
  return (
<footer className="mx-auto mt-1 w-full max-w-container px-4 sm:px-6 lg:px-8" aria-labelledby="footer-heading">
    <div className="items-centers grid grid-cols-1 justify-between gap-4 border-t border-gray-100 py-6 md:grid-cols-2">
        <p className="text-sm/6 text-gray-600 max-md:text-center">
            ...
            <a href="https://learnwithsumit.com/"> TerapyCare</a>. All rights reserved.
        </p>
